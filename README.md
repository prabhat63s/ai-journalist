...
**Slate** is an end-to-end intelligence engine designed for modern investigative journalism. It automates the heavy lifting of deep-dive research, narrative structuring, and editorial auditing, allowing journalists to focus on high-level analysis and verification.
